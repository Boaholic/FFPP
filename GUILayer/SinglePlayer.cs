...
namespace FloatyFloatPewPew
{
    ...
    {
        private static SinglePlayer _instance;
        ...
        public bool CanPlaceShipAI(int currentShip, int cellX, int cellY, bool isHorizontal, Player player)
        {
        ...
        public void AIDeployShips()
        {
            ...
            for (int currentShip = 0; currentShip < 5; currentShip++)
            {
                ...
                DeployShip(currentShip, possibilities[numberOfChosen][0], possibilities[numberOfChosen][1], rotationAspects[numberOfChosen], player2.ShipSet);
            }
        }

        // Adds probability to all the spots the ship can be deployed.
        private void probabilitySetAddShip(int currentShip, int cellX, int cellY, bool isHorizontal, int[,] probabilitySet)
        {
            for (int i = 0; i < shipLengths[currentShip]; i++)
            {
                if (isHorizontal)
       ...
       public int[] AIChooseCellToHit(Player player)
        {
